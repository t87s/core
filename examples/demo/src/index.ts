...
async function runDemo(): Promise<void> {
  ...
  output.curl('curl http://localhost:3000/users/123');
  ...
  output.curl('curl http://localhost:3000/users/123/posts');
  ...
  output.curl('curl -X PUT -H "Content-Type: application/json" -d \'{"name":"Alice Updated"}\' http://localhost:3000/users/123');
  await fetch(`${BASE_URL}/users/123`, {
    method: 'PUT',
  ...
  output.info('');
  output.info('  GET  http://localhost:3000/users/123');
  output.info('  GET  http://localhost:3000/users/123/posts');
  output.info('  PUT  http://localhost:3000/users/123 -d \'{"name":"New Name"}\'');
  output.info('');
