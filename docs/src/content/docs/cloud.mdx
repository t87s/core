...
One popular approach is "dumb cache" - wrap everything in a cache call without any tags, deploy to production, and let it run for 48-72 hours. Then, use the "Prompt for LLMs" button and your favorite AI assistant to analyze your actual traffic patterns and tell you exactly which operations benefit from caching and what TTLs make sense.
