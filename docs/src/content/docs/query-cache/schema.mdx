...
The basic job of any caching system is to store and retrieve unchanging data in a fast-to-access place until said data goes stale, at which point it must be refreshed with up-to-data data.
