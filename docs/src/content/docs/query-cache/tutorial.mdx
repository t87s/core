...
If you want to understand the schema system better, check out [Schema](/query-cache/schema/). If you want to know about TTL and grace periods, check [TTL](/concepts/ttl/) and [Grace Periods](/concepts/grace-periods/). And if you just want to ship something, you have enough to get started. The rest is for what we call in Finnish "pilkunviilaaja". We'll let you ChatGPT that :)