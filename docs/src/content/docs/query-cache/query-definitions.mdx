...
When you call `cache.getUser('123')`, the cache key becomes something like `getUser:["123"]`. When you call `cache.getUserWithPosts('456')`, the key becomes `getUserWithPosts:["456"]`. You don't have to think about it, and you definitely don't have to hand-roll key strings and hope you spelled them consistently.
