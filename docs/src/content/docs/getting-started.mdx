...
This quickstart uses the [QueryCache](/query-cache/schema/) API, but in another world we could have started with [primitives](/primitives/) and you would have been an equally-happy reader.
